...
class ActiveRecord {
    ...
    public function sanitizarAtributos() {
        ...
        foreach ($atributos as $key => $value) {
            if (is_null($value)) {
                $sanitizado[$key] = "NULL"; // Mantén NULL como es
            } else {
    ...
    public static function paginar($por_paginar, $offset){
        $query = "SELECT * FROM " . static::$tabla . " LIMIT ${por_paginar} OFFSET ${offset}" ;
        $resultado = self::consultarSQL($query);
        return $resultado;
    }
    ...
    public function crear() {
        ...
        // Construir los valores, manejando NULL correctamente
        $valores = [];
    ...
    public function actualizar() {
        ...
        foreach ($atributos as $key => $value) {
            if ($value === "NULL") {
                $valores[] = "{$key}=NULL"; // Manejar NULL correctamente
            } else {
                $valores[] = "{$key}='{$value}'";
            }
        }
