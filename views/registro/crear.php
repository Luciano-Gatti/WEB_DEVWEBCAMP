<main class="registro">
    ...
    <div class="paquetes__grid">
        ...
        <div class="paquete">
            ...
            <ul class="paquete__lista">/finalizar-registro/pagar
                <li class="paquete__elemento">Acceso Virtual a DevWebCamp</li>
                <li class="paquete__elemento">Pase por 2 dias</li>
...
<script src="https://www.paypal.com/sdk/js?client-id=ATzBT1kZneSiFt99uUNykNLKZK59ux_DT_6mJiUw43AqmoUsLg3rr7-ZWoDOKnxXqGU3AWphW2Fl0vsh&enable-funding=venmo&currency=USD" data-sdk-integration-source="button-factory"></script>
